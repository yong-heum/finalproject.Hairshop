				...
				<div class="col-md-9 ftco-animate pb-5 text-center">
					<p class="breadcrumbs">
						<span class="mr-2"><a href="mainJSP?id=${sessionScope.sessionId}">Home <i
								...
								<span>개인 매출 확인 <i class="ion-ios-arrow-forward"></i></span>
					</p>
					<h1 class="mb-3 bread">개인 매출 확인</h1>
				</div>
			</div>
		</div>
...
<h2 class="text-center">개인 매출 확인</h2><br><br>

	날짜 선택 : <input type="text" name="date" id="datepicker1"><br><br>

	매출 선택 : <select name="sales_Select" id="sales_Select">
				 <option value="">선택</option>
  				 <option value="0">본인 하루 매출(날짜 전 5일간 매출)</option>
 				 <option value="1">본인 일주일 매출(날짜 전 5주간 매출, 선택 날짜로부터 7일 기준)</option>
 				 <option value="2">본인 달 매출(선택 날짜부터 5달간 매출)</option>
 				 
			 </select>
			 
			 <input type="button" name="sales_confirm" id="sales_confirm" value="확인" onclick="sales_confirm()"><br><br>
