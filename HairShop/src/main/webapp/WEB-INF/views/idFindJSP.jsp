...
<script>
	...
	function idFind1() {
		...
		if ($('#email').val() == ""|| $('#birthDay').val() == ""|| $('#name').val() == "") {
...
<body>
	...
	<form action="idFind" method="post" onsubmit="return false" name="idFind" class="bg-light p-5 contact-form" style="width: 100%;">
		...
		생일 : <input type="date" name="birthDay" id="birthDay" class="form-control"><br>
		전화 번호 : <input type="text" name="tel" id="tel" placeholder="'-'빼고 작성해주세요" class="form-control" style="width: 350px"> <br>
		<input type="submit" value="확인" onclick="idFind1()" class="btn btn-primary py-3 px-5" style="float:right"><br><br>
	</form>
	</div>
	</div>
