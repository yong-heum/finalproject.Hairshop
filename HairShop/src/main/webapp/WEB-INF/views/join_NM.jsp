...
/* 아이디 중복확인,정규식  */
	function idOverlap(){
		...
		$.ajax({
			...
			data : {"id" : idCheck1},   /* 내가 보내줄 데이터 */      /* 처음 id는 내가정해주는 파라미터이름. 두번째 id는 위에 선언한 변수이름. */
...
/* 아이디정규식 */
	function idExp(){
		var idExp = /^[a-zA-Z0-9]{10,15}$/;
		var idExp = document.getElementById('id');
...
/*모두작성이 되었는지 & 아이디 인증 & 비밀번호가 일치 하는지 확인 */
	...
	if($('#id').val()==""||$('#password').val()==""||$('#passwordconfirm').val()==""||$('#name').val()==""||$('#birthDay').val()==""||$('#tel').val()==""||
...
<body>
				...
				<div class="col-md-9 ftco-animate pb-5 text-center">
					<p class="breadcrumbs">
						<span class="mr-2"><a href="loginJSP">Login <i
								class="ion-ios-arrow-forward"></i></a></span> <span>일반 고객 회원가입 <i
	...
	<div class="row block-9 justify-content-center mb-5">
		<div class="col-md-8 mb-md-5">
			...
			<form action="NM_join" method="post" onsubmit="return false"
