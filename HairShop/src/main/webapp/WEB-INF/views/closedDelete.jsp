				...
				<div class="col-md-9 ftco-animate pb-5 text-center">
					<p class="breadcrumbs">
						<span class="mr-2"><a href="mainJSP?id=${sessionScope.sessionId}">Home <i
								...
								<span>휴무 삭제 <i class="ion-ios-arrow-forward"></i></span>
					</p>
					<h1 class="mb-3 bread">휴무 삭제</h1>
				</div>
			</div>
		</div>
...
<h2 class="text-center">휴무 삭제</h2><br><br>

 <form action="ClosedsDelete" method="post" onsubmit="return false" name="submit">
	...
	<input type="hidden" name="disigner_id" id="disigner_id" value="${sessionScope.sessionId}">
 	...
 	휴무 취소 날짜: <input type="text" name="closeds_Date" id="datepicker1"> &nbsp;
 	<input type="submit" onclick="ClosedsDelete()" value="확인">
	<br><br>
	</form>
	</div>
	</div>
